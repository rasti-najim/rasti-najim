...
- 🧠 Software Engineer at **[Sant.ai](https://sant.ai)** — building at an AI startup in New York
- 🥩 Previously shipped **[Protein AI](https://github.com/rasti-najim/protein-ai)** to ~$300 MRR on the App Store
- 🧘 Previously shipped **[Coreflow](https://github.com/rasti-najim/coreflow)** to ~$50 MRR on the App Store

## Experience

- 🤖 **Software Engineer** — Sant.ai
- 🧪 **Lead Engineer** — Intuition
- 🔬 **SWE Intern** — Duke Innovation Co-Lab
- 📊 **SWE Intern** — Plotr
...
- 🥩 **[Protein AI](https://github.com/rasti-najim/protein-ai)** — AI-powered protein tracker. Snap a photo of your meal, get instant protein estimates. Hit **~$300 MRR** on the App Store with a hard paywall. Built with React Native, Expo, Supabase, and OpenAI Vision. ([Backend](https://github.com/rasti-najim/protein-ai-backend))
...
- 📊 **[Next.js Dashboard](https://github.com/rasti-najim/nextjs-dashboard)** — Dashboard app built with Next.js
- 🔐 **[Learn Auth](https://github.com/rasti-najim/learn-auth-frontend)** — Full-stack auth implementation ([Backend](https://github.com/rasti-najim/learn-auth-backend))

---

## GitHub Activity

![GitHub Contribution Graph](https://ghchart.rshah.org/rasti-najim)
...
[![Website](https://img.shields.io/badge/-rastialdawoodi.com-FF5722?style=flat-square&logo=google-chrome&logoColor=white)](https://rastialdawoodi.com)
...
[![X](https://img.shields.io/badge/-@Rasti__Najim-000000?style=flat-square&logo=x&logoColor=white)](https://x.com/Rasti_Najim)
